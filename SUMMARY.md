...
Results: Successful response with today&#39;s rosary prayers.
...
Results: Successful response with rosary prayers for the specified day.
...
| --- | --- | --- | --- |
| Today | `list` | `GET /v1/today` | See reference |
| V1n | `load` | `GET /v1/{day}` | See reference |

## Connect to the API

- Production server: `https://the-rosary-api.vercel.app`
...
- `the-rosary_list`: List records for an entity. Supported entities: `today`.
- `the-rosary_load`: Load one record for an entity. Supported entities: `v1n`.
