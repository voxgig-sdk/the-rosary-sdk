...
// TheRosary SDK ratelimit feature
...
class TheRosaryRatelimitFeature extends TheRosaryBaseFeature
{
    ...
    private function _acquire(TheRosaryContext $ctx): void
    {
    ...
    private function _track(TheRosaryContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
