...
// TheRosary SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class TheRosaryTestFeature extends TheRosaryBaseFeature
{
    ...
    public function init(TheRosaryContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (TheRosaryContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = TheRosaryParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (TheRosaryContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(TheRosaryContext $ctx, $op, $args): array
    {
