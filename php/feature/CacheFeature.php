...
class TheRosaryCacheFeature extends TheRosaryBaseFeature
{
    ...
    private function _through(TheRosaryContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
