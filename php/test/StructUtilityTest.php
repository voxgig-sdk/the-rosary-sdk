...
// TheRosary SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = TheRosaryOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(TheRosaryOmni::structfix($now, Struct::undef()))
                        !== json_encode(TheRosaryOmni::structfix($val, Struct::undef()))) {
