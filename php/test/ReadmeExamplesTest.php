...
// TheRosary SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (TheRosarySDK::test)
...
{
    private const SDK_CLASS = 'TheRosarySDK';
    ...
    private const SDK_BASE = 'therosary_sdk';
