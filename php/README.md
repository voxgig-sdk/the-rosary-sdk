...
The PHP SDK for the TheRosary API — an entity-oriented client using PHP conventions.
...
print_r(array_map(fn($item) => $item->data_get(), $today));
```
...
```
php/
├── therosary_sdk.php          -- Main SDK class
...
The main class (`therosary_sdk.php`) exports the SDK class
