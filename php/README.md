...
The PHP SDK for the TheRosary API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->GetRosaryByDay(null)->list(null, null);
...
[$result, $err] = $client->TheRosary(null)->load(
    ["id" => "test01"], null
);
