...
class TheRosaryMakeRequest
{
    public static function call(TheRosaryContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new TheRosaryResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new TheRosaryResponse($fetched);
        } else {
