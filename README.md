...
Provides various endpoints to access rosary prayers for different days and occasions in JSON format.

Learn more about The Rosary Api at [the-rosary-api.vercel.app](https://the-rosary-api.vercel.app).
...
$todays = $client->Today()->list();
print_r(array_map(fn($item) => $item->data_get(), $todays));
```
