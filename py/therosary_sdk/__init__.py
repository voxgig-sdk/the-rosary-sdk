...
from therosary_sdk.utility import register

# Load features
from therosary_sdk.feature.base_feature import TheRosaryBaseFeature
from therosary_sdk.features import _has_feature, _make_feature
...
class TheRosarySDK:
    ...
    def __init__(self, options=None):
        ...
        utility = TheRosaryUtility()
        self._utility = utility

        from therosary_sdk.config import shared_config
    ...
    def get_utility(self):
        return TheRosaryUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("TheRosarySDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Today(self, data=None) -> "TodayEntity":
        ...
        from therosary_sdk.entity.today_entity import TodayEntity
        return TodayEntity(self, data)


    def V1n(self, data=None) -> "V1nEntity":
        """Entity factory: client.V1n().list() / client.V1n().load({"id": ...})."""
        from therosary_sdk.entity.v1n_entity import V1nEntity
