...
from therosary_sdk.core.control import TheRosaryControl
...
from therosary_sdk.core.helpers import get_ctx_prop, to_map
...
class TheRosaryContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, TheRosarySpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, TheRosaryResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, TheRosaryResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return TheRosaryError(code, msg, self)
