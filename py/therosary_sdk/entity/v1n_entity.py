...
from therosary_sdk.therosary_types import (
    V1n,
    V1nLoadMatch,
)
...
class V1nEntity:
    ...
    def load(self, reqmatch=None, ctrl=None) -> V1n:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.V1n().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
