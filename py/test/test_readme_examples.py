# TheRosary SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions TheRosarySDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both TheRosarySDK(...) and TheRosarySDK.test(...) become
#      TheRosarySDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "therosary_sdk"
_SDK_CLASS = "TheRosarySDK"
