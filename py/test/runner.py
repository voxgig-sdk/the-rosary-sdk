...
class TheRosaryTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = TheRosaryTestRunner.getenv("THEROSARY_TEST_LIVE")
        override = TheRosaryTestRunner.getenv("THEROSARY_TEST_OVERRIDE")
        ...
        explain = TheRosaryTestRunner.getenv("THEROSARY_TEST_EXPLAIN")
        if explain is not None and explain != "":
            m["THEROSARY_TEST_EXPLAIN"] = explain
