...
The SDK exposes the API as capitalised, semantic **Entities** — for example `client.Today()` — each
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/the-rosary-sdk/releases)) or
...
```
py/
├── therosary_sdk.py         -- Main SDK module
