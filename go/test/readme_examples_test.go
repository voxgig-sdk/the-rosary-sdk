...
const testSeed = `map[string]any{"entity": map[string]any{"today": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "v1n": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
