...
func (sdk *TheRosarySDK) OptionsMap() map[string]any {
...
func (sdk *TheRosarySDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *TheRosarySDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *TheRosarySDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *TheRosarySDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *TheRosarySDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath(sdk.options, []any{"allow", "op"}).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *TheRosarySDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath(sdk.options, []any{"allow", "op"}).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("TheRosarySDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *TheRosarySDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *TheRosarySDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("TheRosarySDK: graphql: %s", msg)
		res["graphql"] = errors
	}
