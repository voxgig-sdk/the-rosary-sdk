...
func registerSDKWords(r *eng.Registry, client *sdk.TheRosarySDK) {
...
func runOp(client *sdk.TheRosarySDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
