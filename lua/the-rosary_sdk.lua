...
local TheRosarySDK = {}
TheRosarySDK.__index = TheRosarySDK
...
TheRosarySDK._make_feature = _make_feature


function TheRosarySDK.new(options)
  local self = setmetatable({}, TheRosarySDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function TheRosarySDK:options_map()
...
function TheRosarySDK:get_utility()
  return Utility.copy(self._utility)
end


function TheRosarySDK:get_root_ctx()
  return self._rootctx
end


function TheRosarySDK:prepare(fetchargs)
...
function TheRosarySDK:direct(fetchargs)
...
-- by passing it.
function TheRosarySDK:_raw_request(fetchargs)
  local utility = self._utility
...
function TheRosarySDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "TheRosarySDK: graphql: " .. msg
    res.graphql = errors
  end
...
function TheRosarySDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = TheRosarySDK.new(sdkopts)
  sdk.mode = "test"
