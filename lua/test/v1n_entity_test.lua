...
describe("V1nEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set THE_ROSARY_TEST_V1N_ENTID JSON to run live")
      return
    end
...
function v1n_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("THE_ROSARY_TEST_V1N_ENTID")
