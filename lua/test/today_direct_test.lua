...
describe("TodayDirect", function()
  it("should direct-list-today", function()
    local setup = today_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-today", setup.live and "live" or "unit")
