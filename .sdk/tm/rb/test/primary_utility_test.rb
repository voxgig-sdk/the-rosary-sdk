...
class PrimaryUtilityTest < Minitest::Test
  ...
  def setup
    @runner = TheRosaryOmni.make_runner(TEST_JSON_FILE, TheRosarySDK.test(nil, nil))
  ...
  def test_make_point_basic
    ...
    subject = lambda do |ctx|
      ...
      err.nil? ? point : TheRosaryOmni.errify(err)
    end
