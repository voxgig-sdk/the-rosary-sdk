...
class TheRosaryGraphql
{
    ...
    // equivalent.
    public static function body(TheRosaryContext $ctx): mixed
    {
    ...
    public static function errors(TheRosaryContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
