...
// TheRosary SDK utility: fetcher

class TheRosaryFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; TheRosarySDK/1.0)';
    ...
    public static function call(TheRosaryContext $ctx, string $fullurl, array $fetchdef): array
    {
