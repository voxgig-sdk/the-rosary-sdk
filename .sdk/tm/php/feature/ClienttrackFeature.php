...
// TheRosary SDK clienttrack feature
...
class TheRosaryClienttrackFeature extends TheRosaryBaseFeature
{
    ...
    public function PostConstruct(TheRosaryContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'TheRosary-SDK';
