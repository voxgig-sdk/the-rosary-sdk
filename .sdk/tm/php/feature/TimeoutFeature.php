...
class TheRosaryTimeoutFeature extends TheRosaryBaseFeature
{
    ...
    private function _with_timeout(TheRosaryContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(TheRosaryContext $_ctx, float $ms): void
    {
        $client = $this->client;
