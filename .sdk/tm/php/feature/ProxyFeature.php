...
class TheRosaryProxyFeature extends TheRosaryBaseFeature
{
    ...
    public function init(TheRosaryContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (TheRosaryContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
