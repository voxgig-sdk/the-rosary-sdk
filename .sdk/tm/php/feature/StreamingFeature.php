...
// TheRosary SDK streaming feature
...
class TheRosaryStreamingFeature extends TheRosaryBaseFeature
{
    ...
    private function _iterate(TheRosaryResult $result): \Generator
    {
    ...
    private function _streamable(TheRosaryContext $ctx): bool
    {
