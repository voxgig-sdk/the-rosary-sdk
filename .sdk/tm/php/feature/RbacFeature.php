...
class TheRosaryRbacFeature extends TheRosaryBaseFeature
{
    ...
    private function _required(TheRosaryContext $ctx): ?string
    {
    ...
    private function _reject(TheRosaryContext $ctx, string $required): void
    {
    ...
    private function _track(TheRosaryContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
