...
|---|---|---|
| `ts/` | @voxgig-sdk/the-rosary-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/the-rosary-sdk \
      --repository voxgig-sdk/the-rosary-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/the-rosary-sdk` shows it, and
`npm trust revoke @voxgig-sdk/the-rosary-sdk --id=<id>` removes it.
