...
type Args struct {
	Entity string         `json:"entity" jsonschema:"today | v1n"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.TheRosarySDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "the-rosary_list",
		Description: "List records from TheRosary. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "the-rosary_load",
		Description: "Load a single record from TheRosary. " +
...
func runOp(client *sdk.TheRosarySDK, op string, args Args) (*mcp.CallToolResult, any, error) {
