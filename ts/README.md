# TheRosary TypeScript SDK



The TypeScript SDK for the TheRosary API — a type-safe, entity-oriented client with full async/await support.

The API is exposed as capitalised, semantic **Entities** — e.g.
`client.Today()` — each with a small set of operations (`list`, `load`)
...
| Method | Returns | Description |
| --- | --- | --- |
| `TheRosarySDK.test(testopts?, sdkopts?)` | `TheRosarySDK` | Create a test-mode client. |
...
| `client` | `client(): TheRosarySDK` | Return the parent SDK client. |
...
the-rosary/
├── src/
│   ├── TheRosarySDK.ts        # Main SDK class
