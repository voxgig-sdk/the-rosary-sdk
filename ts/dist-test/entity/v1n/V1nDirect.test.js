...
(0, node_test_1.describe)('V1nDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.TheRosarySDK({
    ...
    (0, node_test_1.test)('direct-load-v1n', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-v1n', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.THE_ROSARY_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.TheRosarySDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['THE_ROSARY_TEST_V1N_ENTID'];
    ...
    const client = new __1.TheRosarySDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=V1nDirect.test.js.map