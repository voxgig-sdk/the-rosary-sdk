...
(0, node_test_1.describe)('TodayDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-today', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-today', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['THE_ROSARY_TEST_TODAY_ENTID'];
