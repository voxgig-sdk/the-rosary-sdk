...
function envOverride(m) {
    if ('TRUE' === process.env.THE_ROSARY_TEST_LIVE ||
        'TRUE' === process.env.THE_ROSARY_TEST_OVERRIDE) {
    ...
    m.THE_ROSARY_TEST_EXPLAIN = process.env.THE_ROSARY_TEST_EXPLAIN || m.THE_ROSARY_TEST_EXPLAIN;
    return m;
}
